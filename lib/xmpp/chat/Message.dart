import 'package:onionchatflutter/xmpp/chat/Chat.dart';
...
class Message {
  ...
  Message(this.messageStanza, this.to, this.from, this._text, this._time,
      {String stanzaId = '',
      String threadId = '',
      ...
      ChatState? chatState}): _stanzaId = stanzaId, _threadId = threadId {
  ...
  static MessageStanzaType _parseType(XmppElement element) {
    ...
    return type ?? MessageStanzaType.CHAT;
  }
