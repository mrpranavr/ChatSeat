...
class ScramSaslHandler implements AbstractSaslHandler {
  ...
  ScramSaslHandler(this._connection, this._password, this._mechanism): _username = _connection.fullJid.local ?? "" {
    initMechanism();
  ...
  void challengeFirst(String content) {
    ...
    var clientProof = List.filled(clientKey.length, 0, growable: false);
